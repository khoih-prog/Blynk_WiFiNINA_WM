...
bool BlynkProtocol<Transp>::processInput(void)
{
    ...
    //KH
#ifdef BLYNK_DEBUG    
    BLYNK_LOG2(BLYNK_F("BlynkProtocol-processInput:readHeader ret = "), ret);
#endif
    ...
    {   
        ...
        //KH
#ifdef BLYNK_DEBUG        
        BLYNK_LOG2(BLYNK_F("BlynkProtocol-processInput:BLYNK_CMD_RESPONSE lastActivityIn = "), lastActivityIn);
#endif
...
// KH, New in v1.0.0    
#define REDIR_SERV_SIZE       64
    
        if (!redir_serv) 
        {
             redir_serv = (char*)malloc(REDIR_SERV_SIZE);
        }
        ...
        // KH, New in v1.0.0
        strncpy(redir_serv, it.asStr(), REDIR_SERV_SIZE);
        redir_serv[REDIR_SERV_SIZE - 1] = '\0';
        //////
