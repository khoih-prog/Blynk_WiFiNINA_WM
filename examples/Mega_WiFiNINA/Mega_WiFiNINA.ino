...
// Be careful, you may run out of memory if turn this on to use dynamic parameters
// Use false if you have not enough memory to run
...
//Defined in <BlynkSimpleWiFiNINA_AVR_WM.h>
/**************************************
  #define MAX_ID_LEN                5
...
#else
// Don't use dynamic parameters to save memory
#include <BlynkSimpleWiFiNINA_AVR_WM_Small.h>
